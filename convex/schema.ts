...
export default defineSchema({
  files: defineTable({ name: v.string(), orgId: v.string(), fileId: v.id("_storage"), type: fileTypes, markAsDelete: v.optional(v.boolean())}).index("by_orgId", ["orgId"]).index("marked_delete", ['markAsDelete']),
